...
public class ImageFragment extends MyFragment {
    ...
    public void doBusiness() {
        ...
        pickerAdapter = new PickerAdapter(R.layout.recycleview_item_album, dataList.getImageList(), mContext);
        pickerAdapter.openLoadAnimation(BaseQuickAdapter.ALPHAIN);
        ryAlbum.setLayoutManager(layoutManager);
        View empty = LayoutInflater.from(mContext).inflate(R.layout.empty_view_no_photo, null, false);
